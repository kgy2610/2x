...
DROP TABLE PITURE_BOARD;
DROP TABLE CHAT;
DROP TABLE PARENTS_BOARD;
DROP TABLE PARENTS_BOARD_REPLY;
DROP TABLE PICTURE_BOARD_PICTURE;
DROP TABLE HOMEWORK_PICTURE;
DROP TABLE PARENTS_BOARD_PICTURE;
DROP TABLE AFTERSCHOOL;
DROP TABLE AFTERSCHOOL_BOARD_PICTURE;
DROP TABLE HOMEWORK_FILE;
DROP TABLE HM_SUBMIT_FILE;
DROP TABLE AFTERSCHOOL_BOARD_FILE;
...
CREATE TABLE TEACHER (
    ...
    TC_QUESTION VARCHAR2(50) NOT NULL,
    TC_ANSWER VARCHAR2(1000) NOT NULL,
...
CREATE TABLE ATTENDANCE (
	ADATE	DATE,
	STU_ID	VARCHAR2(100),
	LA	VARCHAR2(50)		NOT NULL CHECK(LA IN ('L','A')),
...
COMMENT ON COLUMN ATTENDANCE.LA IS '지각/결석(지각:L,결석:A)';
...
/*숙제사진 테이블*/
CREATE TABLE HOMEWORK_PICTURE (
	BO_NO	NUMBER		PRIMARY KEY,
	PIC_AD	VARCHAR2(4000)		NULL
);
COMMENT ON COLUMN HOMEWORK_PICTURE.BO_NO IS '게시판번호';

COMMENT ON COLUMN HOMEWORK_PICTURE.PIC_AD IS '사진경로';
...
CREATE TABLE HM_SUBMIT (
	...
	HM_CONTENT	VARCHAR2(1000),
	SCORE	NUMBER,
	TC_COMMENT	VARCHAR2(1000),
	CREATE_DATE	DATE		DEFAULT SYSDATE,
	STATUS	VARCHAR2(50)	DEFAULT 'N' CHECK(STATUS IN ('Y','N')),
...
COMMENT ON COLUMN HM_SUBMIT.HM_CONTENT IS '숙제내용';
...
/*방과후게시판사진 테이블*/
CREATE TABLE AFTERSCHOOL_BOARD_PICTURE (
	BO_NO	NUMBER		PRIMARY KEY,
	PIC_AD	VARCHAR2(1000)		NOT NULL
);
COMMENT ON COLUMN AFTERSCHOOL_BOARD_PICTURE.BO_NO IS '게시판번호';

COMMENT ON COLUMN AFTERSCHOOL_BOARD_PICTURE.PIC_AD IS '사진경로';


/*방과후게시판첨부파일 테이블*/
CREATE TABLE AFTERSCHOOL_BOARD_FILE (
	BO_NO	NUMBER		PRIMARY KEY,
	ORIGIN_NAME	VARCHAR2(4000)		NOT NULL,
    CHANGE_NAME VARCHAR2(4000)		NOT NULL
);
COMMENT ON COLUMN AFTERSCHOOL_BOARD_FILE.BO_NO IS '게시판번호';

COMMENT ON COLUMN AFTERSCHOOL_BOARD_FILE.ORIGIN_NAME IS '원본이름';

COMMENT ON COLUMN AFTERSCHOOL_BOARD_FILE.CHANGE_NAME IS '바뀐이름';


/*행사사진게시판 테이블*/
CREATE TABLE PITURE_BOARD (
	BO_NO	NUMBER	 PRIMARY KEY,
	TC_ID	VARCHAR2(100)		NOT NULL,
	CLASS_CODE	VARCHAR2(100)		NOT NULL,
	TITLE	VARCHAR2(100)		NOT NULL,
...
COMMENT ON COLUMN PITURE_BOARD.BO_NO IS '게시판번호';

COMMENT ON COLUMN PITURE_BOARD.TC_ID IS '교직원아이디';

COMMENT ON COLUMN PITURE_BOARD.CLASS_CODE IS '반코드';

COMMENT ON COLUMN PITURE_BOARD.TITLE IS '제목';

COMMENT ON COLUMN PITURE_BOARD.CREATE_DATE IS '게시일';

COMMENT ON COLUMN PITURE_BOARD.BO_CONTENT IS '내용';


/*행사사진 테이블*/
CREATE TABLE PICTURE_BOARD_PICTURE (
	BO_NO	NUMBER		PRIMARY KEY,
	PIC_AD	VARCHAR2(1000)		NOT NULL
);
COMMENT ON COLUMN PICTURE_BOARD_PICTURE.BO_NO IS '게시판번호';

COMMENT ON COLUMN PICTURE_BOARD_PICTURE.PIC_AD IS '사진경로';
...
/*학부모커뮤니티사진 테이블*/
CREATE TABLE PARENTS_BOARD_PICTURE (
	BO_NO	NUMBER		PRIMARY KEY,
	PIC_AD	VARCHAR2(1000)		NULL
);
COMMENT ON COLUMN PARENTS_BOARD_PICTURE.BO_NO IS '게시판번호';

COMMENT ON COLUMN PARENTS_BOARD_PICTURE.PIC_AD IS '사진경로';
...
COMMENT ON COLUMN PARENTS_BOARD_REPLY.CLASS_CODE IS '반코드';
...
COMMENT ON COLUMN PROFILE.PIC_NO IS '사진번호';

COMMENT ON COLUMN PROFILE.PIC_AD IS '사진경로';
